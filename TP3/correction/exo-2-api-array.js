...
function majeursSup15k(array) {
  return array
    .filter((o) => o.age >= 18) // on filtre les majeurs
    .map((o) => o.sal) // on transforme le tableau en tableau ne contenant que le salaire
    .every((s) => s >= 1500); // on applique le teste sur tous les éléments du tableau
}
...
// 
// Calculer l’écart type des salaires des personnes majeurs avec un reduce. 
// On pourra utiliser pour cela une équation entre la moyenne des écarts 
// quadratiques et la moyenne des carrés pour éviter de calculer la moyenne. 
// 
